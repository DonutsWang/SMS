...
namespace Always.Sms.Entity.DataModel
{
    ...
    public partial class t_SalaryStucture
    {
        ...
        public Nullable<decimal> TrafficAllowance { get; set; }
        public Nullable<decimal> CommAllowance { get; set; }
        public Nullable<decimal> PositionAllowance { get; set; }
